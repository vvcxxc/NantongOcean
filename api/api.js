...
export function GetScanBarcodeInfo(barcode) {
	return request.baseRequest(`/api/PDA/ScanBarcode/GetScanBarcodeInfo?barcode=${barcode}`, 'GET')
}

export function GetNGList(id) {
	return request.baseRequest(`/api/PDA/Inventory/inventory/GetNGList?WorkOrderOrCenterCode=${id}`, 'GET')
}

export function CreateNGTask(data) {
	return request.baseRequest(`/api/PDA/Inventory/inventory/CreateNGTask`, 'POST', data)
}

export function CreateInventoryTask(data) {
	return request.baseRequest(`/api/PDA/Inventory/inventory/CreateInventoryTask`, 'POST', data)
}

export function GetWorkOrderStock() {
	return request.baseRequest(`/api/PDA/Inventory/inventory/GetWorkOrderStock`, 'GET')
}

export function GetReplaceBarcode(kutai, barcode, WeightConfirm) {
	return request.baseRequest(
		`/api/PDA/ScanBarcode/GetReplaceBarcode?&barcode=${barcode}&WeightConfirm=${WeightConfirm||false}`,
		'GET')
}

export function ChangeBarcode(data) {
	return request.baseRequest('/api/PDA/ScanBarcode/ChangeBarcode', 'POST',data)
}

export function SurplusBack(data) {
	return request.baseRequest(`/api/PDA/Inventory/inventory/SurplusBack`, 'POST', data)
}
